 ...
 */
export async function initializeDriveClient(credentials, token) {
 ...
 */
export async function uploadScreenshotOnFailure(screenshotPath, testTitle) {
  try {
    // Load credentials
    ...
    const fileName = `failure_${safeTestTitle}_${timestamp}.png`;
